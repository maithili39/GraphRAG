...
| Pipeline 2 — Basic RAG | FAISS top-3 → Groq | ~400–600 tokens/query |
...
```powershell
docker run -d --name neo4j-graphrag -p 7474:7474 -p 7687:7687 -e NEO4J_AUTH=neo4j/graphrag1234 neo4j:5.20
```
